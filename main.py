...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет нанесённый урон и возвращает сообщение."""
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает сообщение о применённом специальном умении."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Проводит тренировку в навыках атаки, защиты и специальном умении."""
    if char_class == 'warrior':
